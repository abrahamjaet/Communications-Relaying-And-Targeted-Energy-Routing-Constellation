...
class roi:
    def cost(self, solarPanelSize, batterySize, powerReceiverRad, laserPower, diameterTxM, diameterTxO, totSats,
             orbits):
        # - WEIGHT COSTS - #
        year = 10
        ...
        launch_cost = (4 * 10 ** 6) * numOrbits  # 4 billion for every rocket launch
        ...
        total_cost = cost_weight + (
                    cost_sat * totSats) + cost_ground_station_total + launch_cost + propellant_total_cost + antenna_cost + laser_cost
    ...
    def revenue(self, powerOutputs, commsOutput, totSats):
        ...
        commsOutput = commsOutput * 1.25e-10  # bits to gigabytes
    ...
    def driver(self, currDesign, powerOutput, commsOutput):
        ...
        totCost = self.cost(solarPanelSize, batterySize, receiverRad_power, laserPower, diameterTxM, diameterTxO,
                            totSats, orbits)
        rev_cost = totCost
